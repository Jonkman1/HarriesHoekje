...
Lisa, ik hoop dat je het goed vindt dat ik mij aan jou op trek zo. Dank je wel.

# GitHub
Ik was al vaker van plan hier een stukje over te schrijven. Haar tekst hierover vind ik heel duidelijk.
...
[Happy git with R door Jenny Bryan](https://happygitwithr.com/): great resource although it references the command line quite a bit
